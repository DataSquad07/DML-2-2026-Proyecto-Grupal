...
def limpiar_y_preparar_covid(ruta_entrada='datasets/covid/covid_19_data.csv',
                            ruta_salida='datasets/covid/covid_limpio.csv',
                            semilla=42):
    """
    Realiza todo el flujo de limpieza y particion para el dataset de COVID-19.
    ...
    # =========================================================================
    separador('PASO 0 - INFORMACION INICIAL DEL DATASET COVID-19')
    ...
    # --- 2.3 Deteccion de valores atipicos (IQR) -----------------------------
...
if __name__ == '__main__':
    limpiar_y_preparar_covid(
        ruta_entrada='datasets/covid/covid_19_data.csv',
        ruta_salida='datasets/covid/covid_limpio.csv'
    )